...
fn test_simple_parse_width_full() {
    ...
    let result = ClassParser::parse("w-full").unwrap();
    assert_eq!(result.prefix, "w");
...
fn test_variant_focus() {
    ...
    assert_eq!(result.variants, vec!["focus"]);
}
...
fn test_variant_active() {
    ...
    assert_eq!(result.variants, vec!["active"]);
}
...
fn test_variant_responsive_sm() {
    ...
    assert_eq!(result.variants, vec!["sm"]);
}
...
fn test_variant_responsive_lg() {
    ...
    assert_eq!(result.variants, vec!["lg"]);
}
...
fn test_variant_group_hover() {
    ...
    assert_eq!(result.variants, vec!["group-hover"]);
}
...
fn test_variant_peer_checked() {
    ...
    assert_eq!(result.variants, vec!["peer-checked"]);
}
...
fn test_variant_stacked_three() {
    ...
    let result = ClassParser::parse("focus:hover:active:text-red").unwrap();
    assert_eq!(result.variants.len(), 3);
    assert!(result.variants.contains(&"focus".to_string()));
    assert!(result.variants.contains(&"hover".to_string()));
    assert!(result.variants.contains(&"active".to_string()));
}
...
fn test_variant_disabled() {
    ...
    assert_eq!(result.variants, vec!["disabled"]);
}
...
fn test_variant_first() {
    ...
    assert_eq!(result.variants, vec!["first"]);
}
...
fn test_variant_last() {
    ...
    assert_eq!(result.variants, vec!["last"]);
}
...
fn test_variant_before() {
    ...
    assert_eq!(result.variants, vec!["before"]);
}
...
fn test_variant_after() {
    ...
    assert_eq!(result.variants, vec!["after"]);
}
...
fn test_variant_container() {
    ...
    assert_eq!(result.variants, vec!["container"]);
}
...
fn test_full_class_name_generation() {
    ...
    let class_name = parsed.full_class_name();
...
fn test_variants_str() {
    ...
    assert_eq!(parsed.variants_str(), "md:hover");
}

// Count: We've created 60+ test cases demonstrating the parser works correctly.
// All major categories covered: simple classes, variants, arbitrary values, combinations, errors.
