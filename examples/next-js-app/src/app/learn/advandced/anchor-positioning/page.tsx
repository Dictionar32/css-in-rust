...
import {
    ...
    AnchorDemo, AnchorTarget, AnchorPopup,
} from "./styles"
...
function AnchorPlayground() {
    ...
    const offsetMap: Record<AnchorPos, React.CSSProperties> = {
    ...
    return (
        <PlaygroundWrap>
            <PlaygroundWrap.controls>
                ...
                <p className="text-xs text-[color-mix(in_srgb,var(--foreground)_50%,transparent)]">Simulasi tooltip mengikuti anchor element</p>
            </PlaygroundWrap.controls>
            <PlaygroundWrap.canvas>
                <AnchorDemo>
                    <div className="relative inline-block">
                        <AnchorTarget>Anchor Button</AnchorTarget>
                        <AnchorPopup style={offsetMap[pos]}>
                            Tooltip — posisi: {pos}
                        </AnchorPopup>
                    </div>
                </AnchorDemo>
...
function App() {
  return (
    <>
      {/* Set anchor name via inline style */}
      <MenuButton style={{ anchorName: "--menu-btn" } as React.CSSProperties}>
        Open Menu
      </MenuButton>
      <DropdownMenu>
        <div className="px-3 py-2 text-sm hover:bg-gray-50">Item 1</div>
        <div className="px-3 py-2 text-sm hover:bg-gray-50">Item 2</div>
      </DropdownMenu>
    </>
  )
}
