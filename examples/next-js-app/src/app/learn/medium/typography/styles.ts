...
export const TypoSample = tw.p({
    ...
    defaultVariants: { size: "base", weight: "normal", align: "left" },
})

export const FluidHeading = tw.h2({
    base: "font-bold tracking-tight leading-tight text-[clamp(1.25rem,3vw+0.5rem,2.5rem)]",
})
