...
// ─── Custom property demo card ─────────────────────────────────────────────────
export const ThemeCard = tw.div({
    base: "rounded-xl border p-5 transition-all duration-300",
    variants: {
        theme: {
            default: "bg-white border-gray-200 text-gray-800",
            ocean: "bg-blue-950 border-blue-700 text-blue-100",
            forest: "bg-emerald-950 border-emerald-700 text-emerald-100",
            sunset: "bg-orange-950 border-orange-700 text-orange-100",
        },
    },
    defaultVariants: { theme: "default" },
})

export const ThemeBtn = tw.button({
    ...
    variants: {
        theme: {
            ...
            ocean: "bg-blue-700 text-blue-100 hover:bg-blue-600",
            forest: "bg-emerald-700 text-emerald-100 hover:bg-emerald-600",
            sunset: "bg-orange-700 text-orange-100 hover:bg-orange-600",
        },
    },
    defaultVariants: { theme: "default" },
})
