...
import {
    ...
    MethodCard, MethodGrid, TokenRow, TokenItem,
    ...
    return (
        <PlaygroundWrap>
            ...
            <PlaygroundWrap.canvas>
                <pre className="text-xs font-mono leading-6 whitespace-pre-wrap text-[var(--foreground)]">{examples[tab]}</pre>
            </PlaygroundWrap.canvas>
...
/* ✅ Animasi dan state kompleks */
            `}</Code>
                    ...
                    <Section id="design-tokens" onClick={() => setActiveSection("design-tokens")}>
                        ...
                        <TokenRow>
                            <TokenItem layer="primitive"><TokenItem.badge className="bg-blue-100 text-blue-700">Primitive</TokenItem.badge><TokenItem.name>--blue-500</TokenItem.name><TokenItem.value>#6366f1</TokenItem.value></TokenItem>
                            <TokenItem layer="primitive"><TokenItem.badge className="bg-blue-100 text-blue-700">Primitive</TokenItem.badge><TokenItem.name>--space-4</TokenItem.name><TokenItem.value>1rem</TokenItem.value></TokenItem>
                            <TokenItem layer="semantic"><TokenItem.badge className="bg-violet-100 text-violet-700">Semantic</TokenItem.badge><TokenItem.name>--color-primary</TokenItem.name><TokenItem.value>var(--blue-500)</TokenItem.value></TokenItem>
                            <TokenItem layer="semantic"><TokenItem.badge className="bg-violet-100 text-violet-700">Semantic</TokenItem.badge><TokenItem.name>--space-md</TokenItem.name><TokenItem.value>var(--space-4)</TokenItem.value></TokenItem>
                            <TokenItem layer="component"><TokenItem.badge className="bg-emerald-100 text-emerald-700">Component</TokenItem.badge><TokenItem.name>--btn-bg</TokenItem.name><TokenItem.value>var(--color-primary)</TokenItem.value></TokenItem>
                            <TokenItem layer="component"><TokenItem.badge className="bg-emerald-100 text-emerald-700">Component</TokenItem.badge><TokenItem.name>--card-padding</TokenItem.name><TokenItem.value>var(--space-md)</TokenItem.value></TokenItem>
                        </TokenRow>
