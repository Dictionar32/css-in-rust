...
// ─── css-performance primitives ────────────────────────────────────────────────

export const PipelineStep = tw.div({
    base: "flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-mono font-medium border transition-all",
    variants: {
        phase: {
            parse: "bg-blue-50 border-blue-200 text-blue-800",
            style: "bg-violet-50 border-violet-200 text-violet-800",
            layout: "bg-amber-50 border-amber-200 text-amber-800",
            paint: "bg-orange-50 border-orange-200 text-orange-800",
            composite: "bg-emerald-50 border-emerald-200 text-emerald-800",
        },
    },
    defaultVariants: { phase: "parse" },
})

export const CostBadge = tw.span({
    ...
    defaultVariants: { cost: "cheap" },
})

export const PropertyRow = tw.div({
    base: "flex items-center justify-between px-3 py-2 rounded-lg border text-xs",
    variants: {
        tier: {
            cheap: "bg-emerald-50 border-emerald-100 text-emerald-800",
            medium: "bg-amber-50 border-amber-100 text-amber-800",
            expensive: "bg-red-50 border-red-100 text-red-800",
        },
    },
    defaultVariants: { tier: "cheap" },
})
