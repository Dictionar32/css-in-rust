...
export const TopBar = tw.nav({ base: `sticky top-0 z-50 h-12 border-b border-[color-mix(in_srgb,var(--foreground)_8%,transparent)] bg-[color-mix(in_srgb,var(--surface)_85%,transparent)] backdrop-blur-md` })
...
export const LayoutPreview = tw.div({
    base: "rounded-xl border border-[color-mix(in_srgb,var(--foreground)_10%,transparent)] overflow-hidden my-4 bg-[var(--surface)]",
    sub: {
        "p:label": "text-[10px] font-semibold uppercase tracking-widest px-4 py-2 bg-[color-mix(in_srgb,var(--foreground)_3%,transparent)] border-b border-[color-mix(in_srgb,var(--foreground)_6%,transparent)] text-[color-mix(in_srgb,var(--foreground)_45%,transparent)]",
        "div:demo": "p-4",
    },
})

export const Box = tw.div({
    base: "rounded flex items-center justify-center text-[10px] font-bold text-white p-2 text-center",
    variants: {
        color: {
...
export const HolyGrail = tw.div({
    base: "grid min-h-[200px] rounded-xl overflow-hidden border border-[color-mix(in_srgb,var(--foreground)_10%,transparent)] text-[10px] font-bold text-white",
    style: { gridTemplateAreas: '"header header header" "nav main aside" "footer footer footer"', gridTemplateColumns: "80px 1fr 80px", gridTemplateRows: "40px 1fr 36px" },
})

export const PatternGrid = tw.div({ base: "grid grid-cols-1 sm:grid-cols-2 gap-4 my-4" })
export const PatternCard = tw.div({ base: "rounded-xl border border-[color-mix(in_srgb,var(--foreground)_10%,transparent)] p-4 bg-[var(--surface)] space-y-2" })
export const PatternTitle = tw.p({ base: "text-xs font-semibold" })
export const PatternDesc = tw.p({ base: "text-[11px] text-[color-mix(in_srgb,var(--foreground)_55%,transparent)] leading-relaxed" })
