...
// ─── Accessibility-specific primitives ────────────────────────────────────────
export const FocusDemo = tw.button({
    base: "px-4 py-2 rounded-lg text-sm font-medium border transition-all",
    variants: {
        style: {
            bad: "outline-none bg-indigo-600 text-white border-indigo-600",
            good: "bg-indigo-600 text-white border-indigo-600 focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-indigo-500",
            custom: "bg-white border-gray-300 text-gray-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-500",
        },
    },
...
export const ContrastSwatch = tw.div({
    ...
    sub: {
        "div:bg": "p-4 flex items-center justify-between",
...
export const WcagBadge = tw.span({
    base: "inline-flex items-center gap-1 text-[10px] font-bold px-2 py-0.5 rounded-full",
    variants: {
        level: {
